...
#### Camera Identification (NEW in v1.1.2)
- Set Camera ID
- Set Reel Number
- Set Camera Position

#### LUT Control (NEW in v1.1.2)
- Toggle LUT on SDI 1
- Toggle LUT on SDI 2
- Enable LUT on SDI 1
...
#### Media Information (NEW in v1.1.2)
...
#### Camera Information (NEW in v1.1.2)
